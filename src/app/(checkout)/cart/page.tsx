...
const CartPage = () => {
  const { cartItems, removeItem, clearCart, updateItemQuantity } = useCart();
  ...
  const handleUpdateQuantity = (
    ...
    const item = cartItems.find(
      (i) =>
        String(i.id) === String(productId) && i.selectedSize === selectedSize
    );

    if (item && item.quantity && newQuantity > item.quantity) {
      alert("Cannot add more than available stock!");
      return;
    }

    updateItemQuantity(productId, selectedSize || null, newQuantity);
  };
  ...
  return (
    <div className="container mx-auto px-3 sm:px-4 py-6 sm:py-12 font-poppins">
      <div className="mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl md:text-4xl text-gray-900 mb-3 sm:mb-4">
          Shopping Cart
        </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 sm:gap-8 relative z-0">
                ...
                return (
                  <div key={uniqueKey} className="p-3 sm:p-6">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2 bg-gray-50 rounded-lg p-1.5">
                          <button
                            ...
                            className="w-7 h-7 rounded-full bg-white border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        ...
                        <div>
                          ...
                          <div className="text-base font-medium text-default-cold">
                            $
                            {((item.price || 0) * item.quantityInCart).toFixed(
                              2
                            )}
                          </div>
                        </div>
                    ...
                    <div className="hidden sm:flex items-center space-x-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <h4 className="text-base sm:text-lg text-gray-900 truncate mb-1">
                          {item.name}
                        </h4>
                        {item.selectedSize && (
                      ...
                      <div className="flex flex-col items-center space-y-3">
                        <div className="flex items-center space-x-3 bg-gray-50 rounded-lg p-2">
                          <button
                            ...
                            className="w-8 h-8 rounded-full bg-white border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                            disabled={item.quantityInCart <= 1}
                          >
                            <svg
        ...
        <div className="flex flex-col relative z-10">
          <div className="bg-white rounded-xl border border-default-cold p-4 sm:p-6 text-default-cold lg:sticky lg:top-6 z-10">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link
                href="/"
                className="w-full border-2 border-default-cold text-default-cold hover:bg-default-cold hover:text-white py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg text-center transition-colors duration-200 text-sm sm:text-base"
              >
                Back to home...
              </Link>
            </div>
