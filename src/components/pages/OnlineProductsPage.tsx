  ...
  return (
    <section className="font-roboto text-vintage-green pt-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-0.5">
        {products &&
          products.length > 0 &&
          products.map((onlineExclusiveProduct) => {
            ...
            const defaultImg =
              onlineExclusiveProduct.image_url?.[0] ?? "/AuthClothPhoto.jpg";
            const hoverImg =
              onlineExclusiveProduct.image_url?.[1] ?? defaultImg;
