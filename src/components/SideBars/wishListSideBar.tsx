        ...
        <div className="flex flex-col h-full">
          {wishlistItems.length === 0 ? (
            <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">Save your favorite products to review them later.</p>
              <button
                onClick={onClose}
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4">
                    ...
                    <div className="flex space-x-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-500 mb-3">
                          {item.quantity > 0 ? (
                            <span className="text-green-600">✓ In Stock ({item.quantity} available)</span>
                          ) : (
                ...
                {wishlistItems.length >= 6 && (
                  <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
                    ...
                    <Link href={'/Wishlist'} className="text-sm text-gray-500 mt-1">
