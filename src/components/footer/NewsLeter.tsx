...
export default function Newsletter() {
  return (
    <div className="relative z-20 mb-[-80px] sm:mb-[-60px] lg:mb-[-70px] font-poppins padding-y padding-x bg-white mt-20">
      <div className="w-full max-w-[1600px] mx-auto px-4 flex justify-center">
        <div className="w-full sm:w-[90%] lg:w-[80%] rounded-xl shadow-lg   shadow-vintage-green overflow-hidden grid grid-cols-1 md:grid-cols-2">
